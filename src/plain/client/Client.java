...
public class Client
{
	...
	public class IncomingReader implements Runnable
	{
		...
		public void run()
		{
			...
			{
				append( "CLIENT::Disconnected from server\n" );
	...
	public class ConnectButtonListener implements ActionListener
	{
		...
		public void actionPerformed( ActionEvent event )
		{
			...
			{
				append( "CLIENT::Connection failed. \n" );
			}
	...
	public void loadSettings( File file )
	{
		...
		{
			append( "CLIENT::Couldn't load settings file. Please enter IP and user name.\n" );
		} catch ( IOException e )
		{
